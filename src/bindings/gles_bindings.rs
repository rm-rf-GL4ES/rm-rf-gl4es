...
pub const __gles2_gl32_h_: u32 = 1;
...
>;
pub type PFNGLBLENDBARRIERPROC = ::std::option::Option<unsafe extern "C" fn()>;
...
>;
pub type PFNGLPRIMITIVEBOUNDINGBOXPROC = ::std::option::Option<
    unsafe extern "C" fn(
        minX: GLfloat,
        minY: GLfloat,
        minZ: GLfloat,
